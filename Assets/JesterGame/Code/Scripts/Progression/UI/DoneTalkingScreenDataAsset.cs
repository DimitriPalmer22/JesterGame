...
namespace JesterGame.Code.Scripts.Progression.UI
{
    ...
    /// </summary>
    [CreateAssetMenu(
        fileName = "DoneTalkingScreenDataAsset",
        menuName = "JesterGame/UI/Done Talking Screen Data Asset")
    ]
    public class DoneTalkingScreenDataAsset : UIDataAsset<DoneTalkingScreen>
    {
